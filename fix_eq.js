...
text = text.replace(/\$\$ \\overrightarrow\{PQ\} \\cdot \\overrightarrow\{PR\} = \\begin\{pmatrix\} 1 \\\\\\\\ 4 \\\\\\\\ 2 \\end\{pmatrix\} \\cdot \\begin\{pmatrix\} 2 \\\\\\\\ 5 \\\\\\\\ 7 \\end\{pmatrix\} \$\$\n\$\$ = \(1\)\(2\) \+ \(4\)\(5\) \+ \(2\)\(7\) \$\$\n\$\$ = 2 \+ 20 \+ 14 \$\$\n\$\$ = 36\. \$\$/, 
...
text = text.replace(/\$\$ \|\\overrightarrow\{PQ\}\| = \\sqrt\{1\^2 \+ 4\^2 \+ 2\^2\} \\quad \\quad \|\\overrightarrow\{PR\}\| = \\sqrt\{2\^2 \+ 5\^2 \+ 7\^2\} \$\$\n\$\$ = \\sqrt\{1 \+ 16 \+ 4\} \\quad \\quad = \\sqrt\{4 \+ 25 \+ 49\} \$\$\n\$\$ = \\sqrt\{21\} \\quad \\quad = \\sqrt\{78\}\. \$\$/, 
'$$ |\\overrightarrow{PQ}| = \\sqrt{1^2 + 4^2 + 2^2} = \\sqrt{1 + 16 + 4} = \\sqrt{21}, \\quad |\\overrightarrow{PR}| = \\sqrt{2^2 + 5^2 + 7^2} = \\sqrt{4 + 25 + 49} = \\sqrt{78}. $$');

text = text.replace(/\$\$ \(\\vec\{a\} - \\vec\{b\}\) \\cdot \(\\vec\{a\} \+ 5\\vec\{b\}\) = \\vec\{a\} \\cdot \\vec\{a\} \+ 5\\vec\{a\} \\cdot \\vec\{b\} - \\vec\{b\} \\cdot \\vec\{a\} - 5\\vec\{b\} \\cdot \\vec\{b\} \$\$\n\$\$ = \|\\vec\{a\}\|\^2 \+ 5\(0\) - 0 - 5\|\\vec\{b\}\|\^2 \$\$\n\$\$ = 3\^2 - 5\(1\^2\) \$\$\n\$\$ = 9 - 5 \$\$\n\$\$ = 4\. \$\$/, 
...
text = text.replace(/\$\$ \\begin\{pmatrix\} 3 \\\\\\\\ t \\end\{pmatrix\} = k\\begin\{pmatrix\} -2 \\\\\\\\ 1 \\end\{pmatrix}\. \$\$\nFrom the first component,\n\$\$ 3 = -2k, \\quad k = -\\frac\{3\}\{2\}, \$\$\nso\n\$\$ t = -\\frac\{3\}\{2\}\. \$\$/, 
