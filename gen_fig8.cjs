...
console.log(labelWithArrow(105, 98, 'a', 'yellow', 10));

console.log(arrowLine(O.x, O.y, B.x, B.y, 'yellow', 12));
console.log(labelWithArrow(65, 60, 'b', 'yellow', 10));

console.log(arrowLine(A.x, A.y, B.x, B.y, 'yellow', 12));
console.log(multiLabelWithArrow(135, 45, 'b', 'a', '-', 'yellow', 24));

console.log(arrowLine(A.x, A.y, B_prime.x, B_prime.y, 'black', 12));
console.log(labelWithArrow(145, 125, '-b', 'black', 14));

console.log(arrowLine(O.x, O.y, B_prime.x, B_prime.y, 'black', 12));
console.log(multiLabelWithArrow(70, 140, 'a', 'b', '-', 'black', 24));
