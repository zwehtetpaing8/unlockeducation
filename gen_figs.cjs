...
function arrow(x1, y1, x2, y2, colorClass, width, text, textX, textY, textColorClass) {
  ...
  return `          <line x1="${x1}" y1="${y1}" x2="${lineX2.toFixed(1)}" y2="${lineY2.toFixed(1)}" className="${colorClass}" strokeWidth="${width}" />
...
${arrow(60, 80, 260, 40, 'stroke-[#ca8a04]', 2, '$\\\\vec{a}$', 140, 30, 'text-[#ca8a04]')}
${arrow(60, 80, 100, 72, 'stroke-slate-900 dark:stroke-slate-100', 2, '$\\\\hat{\\\\mathbf{a}}$', 70, 40, 'text-slate-900 dark:text-slate-100')}
...
${arrow(60, 50, 100, 42, 'stroke-slate-900 dark:stroke-slate-100', 2, '$\\\\hat{\\\\mathbf{a}}$', 70, 10, 'text-slate-900 dark:text-slate-100')}
${arrow(60, 90, 260, 50, 'stroke-[#ca8a04]', 2, '$\\\\vec{b} = 5\\\\hat{\\\\mathbf{a}}$', 140, 40, 'text-[#ca8a04]')}
${arrow(260, 120, 60, 160, 'stroke-[#d97706]', 2, '$\\\\vec{b} = -5\\\\hat{\\\\mathbf{a}}$', 140, 110, 'text-[#d97706]')}
...
${arrow(60, 85, 140, 65, 'stroke-[#ca8a04]', 2, '$\\\\overrightarrow{AB}$', 90, 45, 'text-[#ca8a04]')}
${arrow(60, 85, 260, 35, 'stroke-slate-900 dark:stroke-slate-100', 2, '$\\\\overrightarrow{AC}$', 160, 10, 'text-slate-900 dark:text-slate-100')}
          ...
          <text x="255" y="55" className="fill-slate-800 dark:fill-slate-200 text-[12px] font-serif italic stroke-none">C</text>        </svg>
      </div>
    </div>
  );
}`;

fs.writeFileSync('new_figs.txt', fig13 + '\n' + fig14 + '\n' + fig15);
