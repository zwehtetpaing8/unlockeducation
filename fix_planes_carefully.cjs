  ...
  return (
    <div className="my-6 flex justify-center p-4 bg-slate-50 dark:bg-slate-900/50 rounded-2xl border border-slate-100 dark:border-slate-800/80 overflow-x-auto">
      <svg width="300" height="220" viewBox="0 0 300 220" className="max-w-full h-auto">
        ...
        {/* Dashed line on the plane for the right angle */}
        <line x1="180" y1="105" x2="140" y2="100" stroke="currentColor" className="text-slate-900 dark:text-white" strokeWidth="1" strokeDasharray="3 2" />

        {/* Main Vertical Line */}
        <line x1="180" y1="45" x2="180" y2="105" stroke="currentColor" className="text-slate-900 dark:text-white" strokeWidth="1.5" />
  ...
  return (
    <div className="my-6 flex justify-center p-4 bg-slate-50 dark:bg-slate-900/50 rounded-2xl border border-slate-100 dark:border-slate-800/80 overflow-x-auto">
      <svg width="300" height="260" viewBox="0 0 300 260" className="max-w-full h-auto">
        ...
        {/* Dashed line on the top plane for the right angle */}
        <line x1="180" y1="75" x2="140" y2="70" stroke="currentColor" className="text-slate-900 dark:text-white" strokeWidth="1" strokeDasharray="3 2" />
        ...
        {/* Dashed line on the bottom plane for the right angle */}
        <line x1="180" y1="195" x2="140" y2="190" stroke="currentColor" className="text-slate-900 dark:text-white" strokeWidth="1" strokeDasharray="3 2" />
