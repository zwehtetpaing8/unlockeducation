...
// Calculate P arrow (from O to P)
// O = (50, 100)
// P = (90, 20)
// OP = (40, -80)
// Arrow head at P, line needs to stop a bit before P so polygon doesn't overflow.
// Length of OP is sqrt(1600 + 6400) = sqrt(8000) ~= 89.44
// We can just draw line to P, polygon covers it. But wait, P is a point (we can draw a circle there).
