...
const s1 = `<path d="M 60 85 Q 100 85 138 67" fill="none" className="stroke-[#ca8a04]" strokeWidth="2" />
...
const r1 = `<line x1="60" y1="88" x2="138.1" y2="68.5" className="stroke-[#ca8a04]" strokeWidth="2" />
          <polygon points="140.0,68.0 132.8,75.0 130.4,65.2" className="fill-[#ca8a04] stroke-none" />
...
const s2 = `<path d="M 60 85 Q 160 30 258 34" fill="none" className="stroke-slate-900 dark:stroke-slate-100" strokeWidth="2" />
...
const r2 = `<line x1="60" y1="82" x2="258.1" y2="32.5" className="stroke-slate-900 dark:stroke-slate-100" strokeWidth="2" />
          <polygon points="260.0,32.0 252.8,39.0 250.4,29.2" className="fill-slate-900 dark:fill-slate-100 stroke-none" />
          <foreignObject x="150" y="5" width="60" height="30" overflow="visible">
            <div className="flex items-center justify-center w-full h-full text-slate-900 dark:text-slate-100">
              <Latex text="$\\overrightarrow{AC}$" />
            </div>
          </foreignObject>`;
