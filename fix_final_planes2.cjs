  ...
  return (
    <div className="my-6 flex justify-center p-4 bg-slate-50 dark:bg-slate-900/50 rounded-2xl border border-slate-100 dark:border-slate-800/80 overflow-x-auto">
      <svg width="300" height="220" viewBox="0 0 300 220" className="max-w-full h-auto">
        ...
        <line x1="180" y1="105" x2="180" y2="135" stroke="currentColor" className="text-slate-900 dark:text-white" strokeWidth="1.5" strokeDasharray="4 2" />
        <line x1="180" y1="135" x2="180" y2="180" stroke="currentColor" className="text-slate-900 dark:text-white" strokeWidth="1.5" />
        
        {/* Right angle symbol on the right (actually left in original, but visually left) */}
        ...
        {/* Vector Bracket */}
        <path d="M 145 45 L 155 45 L 155 105 L 145 105" fill="none" stroke="currentColor" className="text-slate-900 dark:text-white" strokeWidth="1" />
        <text x="135" y="75" transform="rotate(-90 135 75)" fontSize="11" fill="currentColor" className="text-slate-900 dark:text-white font-mono" textAnchor="middle">⟨3, -2, -1⟩</text>
      </svg>
    </div>
  );
}
  ...
  return (
    <div className="my-6 flex justify-center p-4 bg-slate-50 dark:bg-slate-900/50 rounded-2xl border border-slate-100 dark:border-slate-800/80 overflow-x-auto">
      <svg width="300" height="220" viewBox="0 0 300 220" className="max-w-full h-auto">
        ...
        {/* Right angle symbol on the right */}
        <path d="M 180 95 L 170 93.75 L 170 103.75" fill="none" stroke="currentColor" className="text-slate-900 dark:text-white" strokeWidth="1" />
        ...
        {/* Vector Bracket */}
        <path d="M 145 45 L 155 45 L 155 105 L 145 105" fill="none" stroke="currentColor" className="text-slate-900 dark:text-white" strokeWidth="1" />
        <text x="135" y="75" transform="rotate(-90 135 75)" fontSize="11" fill="currentColor" className="text-slate-900 dark:text-white font-mono" textAnchor="middle">⟨-2, 3, -1⟩</text>
      </svg>
    </div>
  );
}
  ...
  return (
    <div className="my-6 flex justify-center p-4 bg-slate-50 dark:bg-slate-900/50 rounded-2xl border border-slate-100 dark:border-slate-800/80 overflow-x-auto">
      <svg width="300" height="260" viewBox="0 0 300 260" className="max-w-full h-auto">
        ...
        <text x="135" y="80" fontSize="16" fill="currentColor" className="text-slate-900 dark:text-white font-serif italic">Π</text>
        ...
        <line x1="180" y1="75" x2="180" y2="105" stroke="currentColor" className="text-slate-900 dark:text-white" strokeWidth="1.5" strokeDasharray="4 2" />
        <line x1="180" y1="105" x2="180" y2="195" stroke="currentColor" className="text-slate-900 dark:text-white" strokeWidth="1.5" />
        <line x1="180" y1="195" x2="180" y2="225" stroke="currentColor" className="text-slate-900 dark:text-white" strokeWidth="1.5" strokeDasharray="4 2" />
        <line x1="180" y1="225" x2="180" y2="245" stroke="currentColor" className="text-slate-900 dark:text-white" strokeWidth="1.5" />
        ...
        {/* Vector Bracket */}
        <path d="M 145 75 L 155 75 L 155 195 L 145 195" fill="none" stroke="currentColor" className="text-slate-900 dark:text-white" strokeWidth="1" />
        <text x="135" y="135" transform="rotate(-90 135 135)" fontSize="11" fill="currentColor" className="text-slate-900 dark:text-white font-mono" textAnchor="middle">⟨3, -2, -3⟩</text>
      </svg>
    </div>
  );
}
  ...
  return (
    <div className="my-6 flex justify-center p-4 bg-slate-50 dark:bg-slate-900/50 rounded-2xl border border-slate-100 dark:border-slate-800/80 overflow-x-auto">
      <svg width="300" height="260" viewBox="0 0 300 260" className="max-w-full h-auto">
        ...
        {/* Vector Bracket */}
        <path d="M 145 75 L 155 75 L 155 195 L 145 195" fill="none" stroke="currentColor" className="text-slate-900 dark:text-white" strokeWidth="1" />
        <text x="135" y="135" transform="rotate(-90 135 135)" fontSize="11" fill="currentColor" className="text-slate-900 dark:text-white font-mono" textAnchor="middle">⟨-2, 1, 3⟩</text>
      </svg>
    </div>
  );
}
