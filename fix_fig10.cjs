...
const v1_start = { x: 70, y: 90 };
const v1_end = { x: 150, y: 30 };

const v2_start = { x: 170, y: 110 };
const v2_end = { x: 250, y: 50 };
...
console.log(labelWithArrow((v2_start.x + v2_end.x)/2 + 15, (v2_start.y + v2_end.y)/2 + 20, 'b', 'blue', 10));
