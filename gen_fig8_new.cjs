...
console.log(labelWithArrow(105, 105, 'a', 'yellow', 10));
...
console.log(multiLabelWithArrow(140, 45, 'b', 'a', '-', 'yellow', 24));

console.log(arrowLine(A.x, A.y, C.x, C.y, 'yellow', 12));
console.log(labelWithArrow(145, 125, '-b', 'yellow', 14));

console.log(arrowLine(O.x, O.y, C.x, C.y, 'black', 12));
console.log(multiLabelWithArrow(65, 140, 'a', 'b', '-', 'black', 24));
