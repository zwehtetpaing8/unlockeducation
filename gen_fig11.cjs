...
console.log(labelWithArrow((A.x + B.x)/2 - 15, (A.y + B.y)/2 - 10, 'a', 'yellow', 10));

console.log(arrowLine(B.x, B.y, C.x, C.y, 'yellow', 12));
console.log(labelWithArrow((B.x + C.x)/2, B.y - 10, 'c', 'yellow', 10));

console.log(arrowLine(A.x, A.y, D.x, D.y, 'yellow', 12));
console.log(labelWithArrow((A.x + D.x)/2, A.y + 25, 'd', 'yellow', 10));

console.log(arrowLine(D.x, D.y, C.x, C.y, 'black', 12));
console.log(labelWithArrow((D.x + C.x)/2 + 15, (D.y + C.y)/2 + 20, 'b', 'black', 10));

const dot = (x, y) => `<circle cx="${x}" cy="${y}" r="2" className="fill-[#ca8a04] stroke-none" />`;
...
// Labels A, B, C, D
console.log(`<text x="${A.x - 10}" y="${A.y + 10}" className="fill-[#ca8a04] font-serif italic text-sm stroke-none">A</text>`);
console.log(`<text x="${B.x - 10}" y="${B.y - 10}" className="fill-[#ca8a04] font-serif italic text-sm stroke-none">B</text>`);
console.log(`<text x="${C.x + 10}" y="${C.y - 10}" className="fill-[#ca8a04] font-serif italic text-sm stroke-none">C</text>`);
console.log(`<text x="${D.x + 10}" y="${D.y + 10}" className="fill-[#ca8a04] font-serif italic text-sm stroke-none">D</text>`);
