...
export function Chap4_AngleBetweenVectors() {
  return (
    <div className="flex flex-col items-center justify-center p-6 bg-slate-50/50 dark:bg-slate-900/20 border border-slate-100 dark:border-slate-800/80 rounded-2xl shadow-sm my-6">
      <svg width="320" height="260" viewBox="-20 -20 300 240" className="drop-shadow-sm">
        <defs>
        ...
        {/* Axes */}
        <line x1="20" y1="200" x2="260" y2="200" stroke="#eab308" strokeWidth="1.5" markerEnd="url(#arrow-vec)" />
        <line x1="20" y1="200" x2="20" y2="20" stroke="#eab308" strokeWidth="1.5" markerEnd="url(#arrow-vec)" />
        ...
        {/* Angle arc */}
        <path d="M 60 190 A 40 40 0 0 0 45 150" fill="none" stroke="#eab308" strokeWidth="1.5" />
        <text x="65" y="175" fontSize="14" fill="#ca8a04" className="font-serif font-italic">θ</text>

        {/* Vectors */}
        {/* Vector a: O to A (220, 160) */}
        <line x1="20" y1="200" x2="220" y2="160" stroke="#eab308" strokeWidth="2" markerEnd="url(#arrow-vec)" />
        
        {/* Vector b: O to B (120, 60) */}
        <line x1="20" y1="200" x2="120" y2="60" stroke="#eab308" strokeWidth="2" markerEnd="url(#arrow-vec)" />
        
        {/* Vector b-a: A to B */}
        <line x1="220" y1="160" x2="120" y2="60" stroke="#eab308" strokeWidth="2" markerEnd="url(#arrow-vec)" />
