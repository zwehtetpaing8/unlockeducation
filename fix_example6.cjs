...
`Thus the possible vectors are $\\vec{b} = \\begin{pmatrix} \\frac{10}{3} \\\\ -\\frac{10}{3} \\\\ \\frac{5}{3} \\end{pmatrix}$ or $\\vec{b} = \\begin{pmatrix} -\\frac{10}{3} \\\\ \\frac{10}{3} \\\\ -\\frac{5}{3} \\end{pmatrix}$.`
);
