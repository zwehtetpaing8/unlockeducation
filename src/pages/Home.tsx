    ...
    <div className="space-y-20 md:space-y-32 pb-10">
      ...
      <section className="relative pt-6 md:pt-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="inline-flex items-center gap-2.5 px-4 py-2 rounded-2xl bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 text-xs font-black uppercase tracking-widest mb-8 mx-auto lg:mx-0">
              <PlayCircle size={16} />
              <span>Made for Myanmar Students</span>
            </div>
            <h1 className="text-5xl md:text-8xl font-black tracking-tighter mb-8 leading-[0.9] text-neutral-900 dark:text-neutral-50 uppercase">
              Master <br />
              <span className="text-blue-600 dark:text-blue-500">Curriculum</span>
            </h1>
            <p className="text-xl text-neutral-500 dark:text-neutral-400 mb-12 max-w-lg mx-auto lg:mx-0 leading-relaxed font-medium">
            ...
            <div className="flex flex-col sm:flex-row gap-5 justify-center lg:justify-start">
              ...
              <Link 
                to="/past-papers"
                className="bg-white dark:bg-neutral-900 border-2 border-neutral-100 dark:border-neutral-800 hover:border-blue-200 dark:hover:border-blue-900 px-10 py-5 rounded-[2rem] font-black text-center transition-all"
              >
                MATRICULATION
              </Link>
            </div>
          ...
          >
            <div className="relative aspect-[4/5] w-full max-w-lg mx-auto rounded-[3.5rem] bg-neutral-100 dark:bg-neutral-800/50 p-4 border border-neutral-200 dark:border-neutral-800 overflow-hidden shadow-2xl">
              {/* Educational Card UI simulation */}
              <div className="h-full w-full rounded-[2.5rem] bg-white dark:bg-neutral-900 p-8 flex flex-col justify-between">
                <div>
                   <div className="flex justify-between items-start mb-12">
                     <div className="w-12 h-12 rounded-2xl bg-neutral-900 dark:bg-neutral-50 flex items-center justify-center">
                       <BookOpen size={24} className="text-white dark:text-neutral-900" />
                     </div>
                   ...
                   <div className="space-y-6">
                     ...
                     <h3 className="text-4xl font-black tracking-tighter">Complex Numbers</h3>
                     <div className="space-y-2">
                       <div className="h-2 w-full bg-neutral-50 dark:bg-neutral-800 rounded-full" />
                       <div className="h-2 w-[80%] bg-neutral-50 dark:bg-neutral-800 rounded-full" />
                     </div>
                   </div>
                </div>
            ...
            <motion.div 
              ...
              className="absolute -bottom-10 -left-10 bg-white dark:bg-neutral-900 border border-neutral-100 dark:border-neutral-800 p-8 rounded-3xl shadow-2xl z-20"
            >
              <div className="flex items-center gap-5">
                <div className="w-14 h-14 bg-emerald-50 dark:bg-emerald-900/20 rounded-2xl flex items-center justify-center text-emerald-600 transition-colors">
                  <CheckCircle2 size={28} />
                </div>
                <div>
                  <p className="text-3xl font-black tracking-tighter leading-none mb-1">1,000+</p>
                  <p className="text-[10px] text-neutral-400 font-black uppercase tracking-widest">SOLVED PROBLEMS</p>
                </div>
              </div>
            </motion.div>
          </motion.div>
      ...
      <section className="px-4 md:px-0">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
          <div className="max-w-xl">
            <h2 className="text-4xl md:text-6xl font-black tracking-tighter mb-4 text-neutral-900 dark:text-neutral-50 uppercase">Level UP</h2>
          ...
          {grades.map((grade, idx) => (
            ...
            >
              <Link 
                ...
                className={cn(
                  "group block p-8 md:p-10 border rounded-[2.5rem] h-full transition-all hover:shadow-3xl hover:border-blue-200 dark:hover:border-blue-900",
                  "bg-white dark:bg-neutral-900 border-neutral-100 dark:border-neutral-800 overflow-hidden relative"
                )}
              >
                {/* Background Decor */}
                <div className={cn("absolute -top-12 -right-12 w-40 h-40 opacity-5 group-hover:opacity-10 transition-opacity rounded-full", grade.color.split(' ')[0])} />
                ...
                <h3 className="text-3xl font-black mb-4 tracking-tighter group-hover:text-blue-600 transition-colors uppercase leading-none">{grade.title}</h3>
                <p className="text-neutral-500 dark:text-neutral-400 mb-10 text-lg leading-relaxed font-medium">
                  {grade.description}
                </p>
                <div className="flex items-center justify-between mt-auto">
                  <div className="flex flex-col">
                    <span className="text-[10px] font-black text-neutral-300 dark:text-neutral-600 uppercase tracking-widest mb-1">Curriculum</span>
                    <span className="text-sm font-black text-neutral-900 dark:text-neutral-300">
                      {grade.chapters} Full Chapters
                    </span>
                  </div>
                  <div className="w-14 h-14 rounded-full bg-neutral-50 dark:bg-neutral-800 flex items-center justify-center group-hover:bg-blue-600 group-hover:text-white transition-all shadow-inner">
      ...
      {/* Features Grid */}
      <section className="bg-neutral-950 dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-[4rem] p-12 md:p-24 text-white overflow-hidden relative">
        {/* Decor */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center relative z-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-12">
              {features.map((feature, i) => (
                <div key={i} className="group">
                  <div className="w-12 h-12 rounded-xl bg-neutral-800 flex items-center justify-center mb-6 text-blue-400 group-hover:bg-blue-600 group-hover:text-white transition-all">
          ...
          <div className="relative">
            <div className="aspect-video bg-neutral-900 rounded-[3rem] border border-white/5 flex items-center justify-center shadow-3xl">
            ...
            {/* Float badge */}
            <div className="absolute -top-6 -right-6 bg-white dark:bg-neutral-50 px-6 py-4 rounded-3xl shadow-2xl hidden md:block">
